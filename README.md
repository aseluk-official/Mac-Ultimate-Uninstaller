...
>**NOTE**: THIS PROGRAM CAN'T BE PORTED TO ANY OTHER OSES BECAUSE THIS PROGRAM USES *pkgutil* WHICH IS A MACOS TERMINAL COMMAND

>**NOTE**: THIS PROGRAM DOESN'T TAKE ANY PARAMETERS PLEASE RUN WITH
`sudo <path>`
